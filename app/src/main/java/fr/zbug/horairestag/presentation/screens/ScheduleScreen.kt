...
fun ScheduleScreen(
    ...
    viewModel.getCluster(clusterId)
    val cluster by viewModel.cluster.collectAsState()

    viewModel.getSchedules(lineId, clusterId, direction)
    ...
    Log.d("ScheduleScreen", "currentDateTimeFR : $currentDateTimeFR")
    Log.d("ScheduleScreen", "currentTime : $hours:$minutes:$secondes :$currentTime")
    Log.d("ScheduleScreen", "schedules : $schedules")
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(arrival2+"m - "+arrival3+"m", fontSize = 10.sp, modifier = Modifier.padding(bottom = 5.dp))
        }
    }
}
